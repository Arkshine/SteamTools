	...
	*/
	...
	private:
		...
		*/
		...
		struct HookLoopInfo
		{
			...
			SH_META_RES *pStatus;
			SH_META_RES *pPrevRes;
			SH_META_RES *pCurRes;

			SH_META_RES temporaryStatus;				//!< Stored during Post1 recall phase
			bool shouldContinue;
	...
	public:
		...
		*/
		...
		virtual void SetRes(SH_META_RES res);				//!< Sets the meta result
		virtual SH_META_RES GetPrevRes();					//!< Gets the meta result of the previously called handler
		virtual SH_META_RES GetStatus();					//!< Gets the highest meta result
		...
		void SetCurResPtr(SH_META_RES *mres);			//!< Sets pointer to the current meta result
		void SetPrevResPtr(SH_META_RES *mres);			//!< Sets pointer to previous meta result
		void SetStatusPtr(SH_META_RES *mres);			//!< Sets pointer to the status variable
